"""
MasterMind — Hierarchical agent system with manager-worker pattern
...
class Router:
    """Cost- and latency-aware model router for MasterMind."""
...
if __name__ == "__main__":
    import argparse
    p = argparse.ArgumentParser(description="MasterMind: Hierarchical agent system with manager-worker pattern")
